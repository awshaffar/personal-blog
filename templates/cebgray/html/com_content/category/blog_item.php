...
<div class="pcontent">
	...
	if (($params->get('show_author')) || ($params->get('show_category')) || ($params->get('show_create_date')) || ($params->get('show_modify_date')) || ($params->get('show_publish_date')) || ($params->get('show_parent_category')) || ($params->get('show_hits'))) : ?>
